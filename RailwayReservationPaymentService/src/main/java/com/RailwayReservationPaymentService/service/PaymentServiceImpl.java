...
/**
 * @author 
 * Awari Giriraj Service Layer For Implementing Payment Microservice
 */
@Service
public class PaymentServiceImpl implements PaymentService {
	...
	public void sendEmail(PaymentDetails payment) throws AddressException {
		final Email email = DefaultEmail.builder().from(new InternetAddress("awarigiriraj@gmail.com"))
				.replyTo(new InternetAddress("awarigiriraj@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("awarigiriraj@gmail.com")))
